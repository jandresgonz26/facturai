...
export const TOOL_LABELS: Record<string, string> = {
    ...
    list_client_notes: 'Leyendo las notas del cliente',
    update_client_note: 'Actualizar nota',
    convert_client_note_to_task: 'Convertir la nota en tarea',
    delete_client_note: 'Eliminar nota',
