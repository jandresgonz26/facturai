...
- Un ítem nuevo que dicte el usuario es PUNTUAL por defecto. Solo crea un servicio fijo si el usuario lo pide explícitamente ("todos los meses", "fijo", "recurrente").
